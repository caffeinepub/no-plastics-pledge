...
export class Backend implements backendInterface {
    ...
    async getRecentCertificates(): Promise<Array<Certificate>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentCertificates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalPledges(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalPledges();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async takePledge(arg0: string, arg1: string): Promise<Certificate> {
        if (this.processError) {
            try {
                const result = await this.actor.takePledge(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
